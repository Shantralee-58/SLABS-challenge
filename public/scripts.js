...
{instructions:"Q10: Letter Decipher", question:"If Z=1, Y=2, X=3… what is CAT?", options:["54","26","57","23"], answer:2, example:"Sum the letter values according to the reversed alphabet mapping"}, 
...
{instructions:"Q16: Word Decipher", question:"If PEN=16, NOTE=27, BOOK=?", options:["24","28","27","26"], answer:1, example:"Sum letter values using a given mapping pattern"}, 
