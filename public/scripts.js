...
{instructions:"Q2: Word Decipher", question:"If A=1, B=20, C=3, D=40 what is DOG?", options:["62","57","48","50"], answer:0, example:"Sum letter values according to mapping A=1,B=20,C=3, D=40"},
...
{instructions:"Q6: Clock Logic", question: "If it takes 5 machines 5 minutes to make 5 widgets, how long would it take 100 machines to make 100 widgets?", options: ["5 minutes","20 minutes","100 minutes","500 minutes"], answer: 0, example: "Each machine makes one widget in 5 minutes."},
...
{instructions:"Q8: Logical Reasoning", question:"Four people need to cross a bridge at night. They have one torch and the bridge is too dangerous to cross without it. Only two people can cross at a time, and they must carry the torch. When two cross together, they move at the speed of the slower person. Times to cross: A = 1 minute B = 2 minutes C = 7 minutes D = 10 minutes\n\nWhat is the minimum total time for all four to cross?", options:["8 minutes","15 minutes","17 minutes","21 minutes"], answer:2, example:"Only 2 cross at once. Torch must return. Think who should bring the torch back to minimize total crossing time."},
{instructions:"Q9: Number Puzzle", question:"If 2+3=10, 3+4=21, 4+5=?, 5+6=?", options:["30,35","35,41","36,55","40,50"], answer:2, example:"Follow the pattern: (a+b) * a"}, 
...
{instructions:"Q12: Grid Puzzle", question:"Which number fills the blank?\n2 4 8\n3 6 12\n4 8 ?", options:["16","18","20","24"], answer:0, example:"Each term doubles the number"}, 
{instructions:"Q13: Alphabet Coding", question:"If FLOWER is coded as GMPXFS, how is GARDEN coded?", options:["HBSEFN","HBSDFO","HBSEFO","GZQCDM"], answer:2, example:"Each letter moves one position forward in the alphabet."}, 
...
{instructions:"Q19: Race Challenge", question: "You overtake the person who is in second place in a race. What position are you in now?", options: ["First","Second","Third","Cannot be determined"], answer: 1, example: "If you pass the person in second place, you take their position"}, 
...
{instructions:"Q21: Logic Puzzle", question: "Which weighs more?", options: ["1 kg of feathers","1 kg of steel","They weigh the same","Cannot be determined"], answer: 2, example: "Both have the same mass: 1 kilogram."}, 
...
{instructions:"Q28: Pattern Recognition", question: "What are the next three numbers in the sequence?\n\n5, 14, 2, 7, 11, 6, 9, 8, 10, ?", options:["12, 7, 3","6, 5, 7","11, 5, 14","14, 17, 12"], answer: 2, example: "Look for the hidden repeating pattern rather than simple arithmetic."}, 
